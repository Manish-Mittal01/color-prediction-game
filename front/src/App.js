...
} from "./Components/Recharge/Recharge";
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/riskmanagements"
            element={<Auth Comp={Riskmanagement} />}
          />
          ...
          <Route
            path="/RechargeRecord"
            element={<Auth Comp={Recharge_Record} />}
          />
          ...
          <Route
            path="/SubmitRechargeRequest"
            element={<Auth Comp={SubmitRechargeRequest} />}
          />
        </Routes>
        <Footer />
      </BrowserRouter>
